...
const About = ({lightMode}) => {
    ...
    return(
        ...
        <div className={lightMode ? 'aboutMe tagLight': 'aboutMe tagDark'}>
            ...
            My experience is mostly in ReactJs, recently I've been laid off and I've been ramping up creating new projects learning new skills. Beyond the stress of looking for a new position, 
            having the time to consider what type of projects I'm interested in working on has been very fun. My two latest projects have been learning 3D animation with react-three-fiber, and a Math website for my two nephews who are always asking me to quiz them! Surely there is more to come with these projects and others.
